    ...
    <div class="carousel-inner">
        ...
        <div class="item">
            ...
            <div class="carousel-caption">
                <div class="col-md-12 yt">
                    <h5>Ready to go</h5>
                    <h4>Click the Login or Sign Up!</h4>
                    <div class="button-yt">
                        <p><a class="btn btn-primary btn-lg" href="indexLogin.jsp" role="button" data-anijs="if: mouseover, do: pulse animated">Login</a></p>
                    	<p><a class="btn btn-primary0 btn-lg" href="indexLogin.jsp" role="button" data-anijs="if: mouseover, do: pulse animated">Sign Up!</a></p>                    
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="about">
        <div class="row About-Us">
            ...
            <div class="col-md-6 counters" data-sr='wait 0.1s, then enter right and hustle 125px over 1.5s'>
                <h2 >STAY TUNED</h2>
                <div class="testimonial-border-white"></div>
                <h3 >Our next project is almost ready. We are coming in:</h3>
                <ul id="example" >
                    <li><span class="days">00</span><p class="D_text">DAYS</p></li>
                    <li class="seperator"></li>
                    <li><span class="hours">00</span><p class="H_text">HRS</p></li>
                    <li class="seperator"></li>
                    <li><span class="minutes">00</span><p class="M_text">MIN</p></li>
                    <li class="seperator"></li>
                    <li><span class="seconds">00</span><p class="S_text">SEC</p></li>
                </ul>
            </div>
        </div>
    </section>
...
<div class="container-fluid">
    <section id="team">
        <div class="row our-team">
            <h2 data-sr='wait 0.1s, then enter top and hustle 100px over 1s'>Our Team</h2>
